...
namespace Lvmendes.Educacional.Comum.Repositorio.Migrations
{
    ...
    [Migration("20230727193845_telefone_endereco")]
    partial class telefone_endereco
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lvmendes.Educacional.Comum.Entidades.ConteudoMateriaEntidade", b =>
                {
                    ...
                    b.Property<long?>("MateriasEntidadeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Lvmendes.Educacional.Comum.Entidades.MateriasEntidade", b =>
                {
                    ...
                    b.Property<long>("ProfessorTitularId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Lvmendes.Educacional.Comum.Entidades.ConteudoMateriaEntidade", b =>
                {
                    b.HasOne("Lvmendes.Educacional.Comum.Entidades.MateriasEntidade", null)
                        .WithMany("conteudoMaterias")
                        .HasForeignKey("MateriasEntidadeId");
                });
            ...
            modelBuilder.Entity("Lvmendes.Educacional.Comum.Entidades.MateriasEntidade", b =>
                {
                    b.HasOne("Lvmendes.Educacional.Comum.Entidades.ProfessorEntidade", "ProfessorTitular")
                        .WithMany()
                        .HasForeignKey("ProfessorTitularId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProfessorTitular");
                });
