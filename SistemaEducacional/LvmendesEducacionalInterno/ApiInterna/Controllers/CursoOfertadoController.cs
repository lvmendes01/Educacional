...
namespace ApiInterna.Controllers
{
    ...
    [ApiController]
    public class CursoOfertadoController : ControllerBase
    {
        private readonly ICursoOfertadoServico servico;

        public CursoOfertadoController(ICursoOfertadoServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(CursoOfertadoModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "CursoOfertadoEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(CursoOfertadoModelo item)
        {
