...
namespace ApiInterna.Controllers
{
    ...
    public class AlunoController : ControllerBase
    {
        ...
        public AlunoController(IAlunoServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(AlunoModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "AlunoEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(AlunoModelo item)
        {
