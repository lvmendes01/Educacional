...
namespace ApiInterna.Controllers
{
    ...
    {
        private readonly IDisciplinaCursadaServico servico;

        public DisciplinaCursadaController(IDisciplinaCursadaServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(DisciplinaCursadaModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "DisciplinaCursadaEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(DisciplinaCursadaModelo item)
        {
