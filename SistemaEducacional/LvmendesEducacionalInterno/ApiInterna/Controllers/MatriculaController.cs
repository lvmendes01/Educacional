...
namespace ApiInterna.Controllers
{
    ...
    {
        private readonly IMatriculaServico servico;

        public MatriculaController(IMatriculaServico _servico)
        {
            servico = _servico;
        }
        ...
        public ActionResult<RetornoApi> Salvar(MatriculaModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "MatriculaEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(MatriculaModelo item)
        {
