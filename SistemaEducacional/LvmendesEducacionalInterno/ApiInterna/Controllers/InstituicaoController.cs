...
namespace ApiInterna.Controllers
{
    ...
    {
        private readonly IInstituicaoServico servico;

        public InstituicaoController(IInstituicaoServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(InstituicaoModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "InstituicaoEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(InstituicaoModelo item)
        {
