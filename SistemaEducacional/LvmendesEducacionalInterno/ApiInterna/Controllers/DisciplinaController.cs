...
namespace ApiInterna.Controllers
{
    ...
    public class DisciplinaController : ControllerBase
    {
        ...
        private readonly IDisciplinaServico servico;

        public DisciplinaController(IDisciplinaServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(DisciplinaModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "DisciplinaEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(DisciplinaModelo item)
        {
