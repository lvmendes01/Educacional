...
namespace ApiInterna.Controllers
{
    ...
    {
        private readonly IPeriodoServico servico;



        public PeriodoController(IPeriodoServico _servico)
        {
            servico = _servico;
        }
        [HttpPost("Salvar")]
        ...
        public ActionResult<RetornoApi> Salvar(PeriodoModelo item)
        {
        ...
        public ActionResult<RetornoApi> Lista(bool todos)
        {
            ...
            RetornoApi retorno = new RetornoApi
            {
                ...
                Mensagem = retornoChamado == null ? "PeriodoEntidades não Encontrado" : string.Empty
        ...
        [ProducesResponseType(StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public ActionResult<RetornoApi> Atualizar(PeriodoModelo item)
        {
